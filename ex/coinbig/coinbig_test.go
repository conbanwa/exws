...
func TestCoinBig_BuildSigned(t *testing.T) {
	...
	s, _ := wstrader.GetParamMD5Sign("", param)
	t.Log(s)
}
...
func TestCoinBig_GetUnfinishOrders(t *testing.T) {
	//return
	t.Log(cb.GetUnfinishedOrders(cons.BTC_USDT))
}
func TestCoinBig_GetOneOrder(t *testing.T) {
	return
	t.Log(cb.GetOneOrder("1111", cons.BTC_USDT))
}
func TestCoinBig_CancelOrder(t *testing.T) {
	return
	t.Log(cb.CancelOrder("1111", cons.BTC_USDT))
}
func TestCoinBig_GetTicker(t *testing.T) {
	return
	t.Log(cb.GetTicker(cons.BTC_USDT))
}
func TestCoinBig_GetDepth(t *testing.T) {
	return
	t.Log(cb.GetDepth(3, cons.BTC_USDT))
}
func TestCoinBig_LimitBuy(t *testing.T) {
	return
	t.Log(cb.LimitBuy("1", "1", cons.BTC_USDT))
}
