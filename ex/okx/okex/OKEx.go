...
func (ok *OKEx) BuildRequestBody(params any) (string, *bytes.Reader, error) {
	if params == nil {
...
func (ok *OKEx) GetUnfinishedOrders(currency CurrencyPair) ([]Order, error) {
	return ok.OKExSpot.GetUnfinishedOrders(currency)
}
