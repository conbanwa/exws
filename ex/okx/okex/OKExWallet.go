...
func (ok *Wallet) GetAccount() (*Account, error) {
	var response []struct {
...
*/
func (ok *Wallet) Withdrawal(param WithdrawParameter) (withdrawId string, err error) {
	var response struct {
		Result       bool   `json:"result"`
...
func (ok *Wallet) GetDepositAddress(currency Currency) ([]DepositAddress, error) {
...
func (ok *Wallet) GetWithDrawalFee(currency *Currency) ([]WithdrawFee, error) {
...
func (ok *Wallet) GetWithDrawHistory(currency *Currency) ([]DepositWithdrawHistory, error) {
...
func (ok *Wallet) GetDepositHistory(currency *Currency) ([]DepositWithdrawHistory, error) {
